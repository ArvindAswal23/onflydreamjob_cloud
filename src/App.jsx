...
import { NavBar,Footer, Home,AllJobs,AllJobByLocation,Job,ErrorPage,NoJobFound,ALlJobByType,AllJobByDepartment,AboutUs,ContactUs,
  Articles,Article1,Article2,Article3,Article4,Article5, RBGoogleForm, ResumeBuilder, Builder} from './components/index'
    ...
    <div>
      ...
      <Router>
        <Routes>
          ...
          <Route path="/builder" element={<Builder />} exact />
