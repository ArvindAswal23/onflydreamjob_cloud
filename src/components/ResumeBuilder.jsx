            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div class="lg:pr-8 lg:pt-4">
                        ...
                        <h2 class="text-base font-semibold leading-7 text-sky-800">Automate your CV creation with our AI resume builder.</h2>
                    ...
                    <img src="https://d1civoyjepycei.cloudfront.net/static/img/ai_writer_features/ai_resume_showcase.ae0bb09a7667.gif" alt="Product screenshot" class="w-[44rem] max-w-none rounded-xl shadow-xl ring-2 ring-black-100 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
                    </div>
                </div>
            </div>
{/* Button */}
