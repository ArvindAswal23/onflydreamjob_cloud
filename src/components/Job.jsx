...
const Job = () => {
  ...
  return (  
      <div className='bg-primary w-full overflow-hidden'>
          <div className="text-2xl font-medium font-poppin text-gray-800 dark:text-white"> <h2 className="text-center">Job Details For "{jobDetail.map((jd) => [jd.companyName])}"</h2></div>
